...
label day2:
    ...
    pdd "Книги помогали мне сбежать от реальности. Яркие миры разнообразных художественных книг заменяли мне грязные, пыльные, душные улицы Асмары{p} К 12 годам я начал изучать базовые науки. Научился читать и писать{p} Я ночевал в библиотеке. Дома даже никто и не заметил что я пропал"
    ...
    "Матвея сидел и давил довольную улыбку"
