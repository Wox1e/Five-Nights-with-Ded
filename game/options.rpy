...
define config.name = _("Пять ночей с дедом")
...
define gui.about = _p("""
Все персонажи вымышленные, совпадения случайны. Если вы заметили какие-то сходства с реальными личностями и событиями, советую обратится к {b}психиатору{/b}
""")
...
define config.sample_sound = "удары палкой по жопе.ogg"
define config.sample_voice = "гойда.ogg"
...
define config.save_directory = "ded_game-1770388391"
